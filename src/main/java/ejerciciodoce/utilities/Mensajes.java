...
//        Vacio ya que no es necesario manejar atributos
     ...
     * @since [1.0.0]
     */
    public void mostrarInfoUno() {
        loggerMensaje.log(Level.WARNING, "ingrese la palabra 1:");
    }
     ...
     * @since [1.0.0]
     */
    public void mostrarInfoDos() {
        loggerMensaje.log(Level.WARNING, "ingrese la palabra 2:");
    }
}
