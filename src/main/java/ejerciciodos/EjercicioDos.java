...
public class EjercicioDos {
    /**
     * [Metodo principal, el cual hace la operacion de comparar 2 numeros ingresados por consola y
     * ordenarlos de mayor a menor, teniendo en cuenta la excepcion de que sean iguales.]
     *
    ...
    public static void main(String[] args) {
        ...
        Logger logger = Logger.getLogger(ejerciciouno.Ejercicio1.class.getName());
